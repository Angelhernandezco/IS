...
<div class="titulo">
    <h1> VALOR ANUAL EQUIVALENTE (VAE) </h1>
</div>
...
<div class="contenedor2">
    ...
    if (isset($_POST['submit'])) { 
        ...
        <div class="tabla-grid">
            ...
            $VAE = $VPN * ($interes / (1 - (pow((1 + $interes), -$numAnios))));
            ?> 
            <h3>El VAE es: $<?= number_format($VAE, 3) ?></h3><!-- Cierre de la tabla -->
            <?php
            if ($VAE > 0) {
                echo "<h3>El proyecto tendrá ganancias, porque el VAE es mayor que 0</h3>";
            } else if ($VAE < 0) {
                echo "<h3>El proyecto tendrá pérdidas, porque el VAE es menor que 0</h3>";
            } else {
                echo "<h3>No habrá ganancias en el proyecto, porque el VAE es 0</h3>";
            } 
            ?> 
